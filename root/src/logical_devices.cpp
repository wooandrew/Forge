...
namespace Forge {
    ...
    // Initialize 
    int LogicalDevice::init(VkPhysicalDevice physicalDevice, VkSurfaceKHR& surface) {

        // If the logical device is an interface to a physical graphics card
        if (type == DeviceType::GraphicsCard) {
